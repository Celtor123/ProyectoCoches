...
"""
Base de datos que arranca nada más empezar el proyecto.rst
"""
...
cursor.execute("create table if not exists clientes  (dni text primary key not null unique,nombre text not null,departamento text)")
...
class Principal(Gtk.Window):
    def __init__(self):
     ...
     background:red;
        ...
        Boton1.connect("clicked", self.Cliente)
    ...
    """
            Esta es la ventana donde aparencen los servicios y productos, los cuales el usuario decide que hacer con ellos.
            :param win: Ventana Principal para ponerla invisible una vez se inicie la secundaria
            :param widget: Señal del botón que hace iniciar a la clase
            :param Grid: alamacenaje de los widgets de la clase
            :        
    """
    class Producto(Gtk.Window):
        def __init__(self, widget):
              Gtk.Window.__init__(self, title="Xestión de productos", name="ventanaproductos")
        ...
        """
        Método para imprimir los datos de productos y servicios en un pdf
        :param titulo: Los campos mostrados
        :param valor: Los valores de estos
        :param t: La tabla que se imprime             
        """
        def imprimir(self, widget):
                  ...
                  """
                  >>> x=0
                  UnboundLocalError: La variable valor debe de tener un valor 
                  sino saldrá refernciada sin valor
                  """
                  # print(tupla)
                  try:
                   x = len(valor)
                      ...
                      """
                      >>>print("no hay valor al no haber valores en la tabla")
                      """
                      x=1
        ...
        """
        Crea una ventana para ingresar un producto y su servicio
        :param widget: La señal para activar la clase
        :param entrada: el valor de cada uno de los valores
        ...
        """
        Crea una ventana para eliminar un producto y su servicio
        :param widget: La señal para activar la clase
        """
    ...
    """
    Clase Xestión hace que aparezca un listado de clientes y unas acciones para hacer con ellos que son añadir, elminir y consultarlos
    :param widget: Recibe la señal del boton de la venatana principal
    """
    ...
    class Cliente(Gtk.Window):
        ...
        """
        Esta clase da la posibidad de insertar, consultar o borrar clientes
        :param sting: El string que determina qué quiere hacer el usuario
        """
        class Opciones(Gtk.Window):
            def __init__(self, string,strar):
                Gtk.Window.__init__(self, title=string + " consultar",name="ventanaterciaria")
                ...
                if string == "Consultar":
                    ...
                    comba.connect("changed", consultar)
                    renderer_text = Gtk.CellRendererText()
